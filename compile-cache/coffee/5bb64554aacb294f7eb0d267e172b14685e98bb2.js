(function() {
  ...
  SuggestionListElement = (function(_super) {
    ...
    SuggestionListElement.prototype.updateDescription = function(item) {
      item = item != null ? item : this.visibleItems()[this.selectedIndex];
    ...
    SuggestionListElement.prototype.renderItems = function() {
      var descLength, index, item, items, li, longestDesc, longestDescIndex, _i, _len, _ref;
      ...
      return this.updateDescription(items[longestDescIndex]);
    };
    ...
    SuggestionListElement.prototype.readUIPropsFromDOM = function() {
      ...
      this.uiProps.width = this.offsetWidth;
