(function() {
  ...
  module.exports = GoExecutable = (function() {
    ...
    GoExecutable.prototype.detect = function() {
      ...
      executables = _.chain(executables).uniq().map(function(e) {
      ...
      return async.map(executables, this.introspect, (function(_this) {
        return function(err, results) {
          if (err != null) {
            console.log('Error mapping go: ' + err);
          }
          _this.gos = _.compact(results);
          _this.gos = _.filter(_this.gos, function(go) {
            var _ref2;
            return (go != null ? (_ref2 = go.executable) != null ? _ref2.length : void 0 : void 0) > 0;
          });
    ...
    GoExecutable.prototype.introspect = function(executable, outercallback) {
      var go;
      go = new Go(executable, this.pathexpander);
      return async.series([
        (function(_this) {
          return function(callback) {
            ...
            try {
              return _this.executor.exec(executable, false, _this.env, done, ['version']);
            } catch (_error) {
              error = _error;
          ...
          return function(callback) {
            ...
            try {
              if (go !== null) {
                return _this.executor.exec(executable, false, _this.env, done, ['env']);
              }
            } catch (_error) {
              error = _error;
              return console.log('go [' + executable + '] is not a valid go');
            }
          };
        })(this)
