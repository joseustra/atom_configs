(function() {
  describe("AtomColorHighlight", function() {
    ...
    describe('when a rgba() expression is followed by parentheses', function() {
      beforeEach(function() {
      ...
      return it('stops at the end of the rgba() declaration', function() {
        markers = editorElement.shadowRoot.querySelectorAll('color-marker');
        return expect(markers.length).toEqual(2);
      });
    });
